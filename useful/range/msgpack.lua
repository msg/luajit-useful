...
local PACKET_HEADER_SIZE	= 12
msgpack.PACKET_HEADER_SIZE	= PACKET_HEADER_SIZE
...
msgpack.encode_packet = function(data, r8)
	local sr8	= r8:save()
	r8:pop_front(PACKET_HEADER_SIZE)	-- make room for header
	local p8	= r8:save()
	encode(data, r8)
	p8.back		= r8.front
